<template name="components">
	<view>
		<scroll-view scroll-y class="page">
			<cu-custom bgImage="https://ossweb-img.qq.com/images/lol/web201310/skin/big91012.jpg">
				<block slot="content">
		...
		data() {
			return {
				...
				list: [{
					...
					{
						title: '微动画',
						img: 'https://ossweb-img.qq.com/images/lol/web201310/skin/big81005.jpg',
						url: '../plugin/animation'
					},
					{
						title: '全屏抽屉',
						img: 'https://ossweb-img.qq.com/images/lol/web201310/skin/big25002.jpg',
						url: '../plugin/drawer'
					},
					{
						title: '垂直导航',
